	...
	return results === null ? "" : decodeURIComponent(results[1].replace(/\+/g, " "));
			...
			$(function(){
				...
				$("#submit button").click(function(){
					window.location.href = "step2noavail.html?fnameold=" + fname + "&fnamenew=" + $("#fname").val() + "&lnameold=" + lname + "&lnamenew=" + $("#lname").val()  + "&cid=" + $("#cid option:checked").val() + "&cim=" + $("#cim option:checked").val() + "&cod=" + $("#cod option:checked").val() + "&com=" + $("#com option:checked").val();
				})
